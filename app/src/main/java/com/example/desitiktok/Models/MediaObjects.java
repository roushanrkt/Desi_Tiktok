package com.example.desitiktok.Models;
...
public class MediaObjects {
    ...
    public MediaObjects(String title, String description, String date, String user_id, String post_categories, String post_id, String view, String user_name, String media_url, String thumbnail) {
        this.title = title;
